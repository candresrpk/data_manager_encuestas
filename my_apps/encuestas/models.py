...
class Distribucion(models.Model):
    ...
    genero = models.CharField(max_length=50, blank=True, null=True, choices=GeneroChoices.choices, default=GeneroChoices.MASCULINO)
...
class Respuesta(models.Model):
    ...
    encuestador = models.ForeignKey(User, on_delete=models.CASCADE, related_name='usuario_respuestas')
